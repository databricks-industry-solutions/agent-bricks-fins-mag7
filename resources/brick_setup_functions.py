...
class AgentBricksManager:
  ...
  def ka_get(self, tile_id: str) -> Optional[Dict[str, Any]]:
    ...
    Returns:
        KA data if found, None if not found or doesn't exist.
    """
    try:
  ...
  def ka_list_examples(
    ...
    Returns:
        List of examples with pagination info
    """
  ...
  def mas_get(self, tile_id: str) -> Optional[Dict[str, Any]]:
    """Get MAS by tile_id using the MAS-specific endpoint.

    Returns:
        MAS data if found, None if not found or doesn't exist.
    """
    try:
  ...
  def genie_get(self, space_id: str) -> Optional[Dict[str, Any]]:
    ...
    Returns:
        Genie space data if found, None if not found or doesn't exist.
    """
    try:
